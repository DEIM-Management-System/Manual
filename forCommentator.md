...
8. セッション開始時刻に，座長がセッション開始を宣言します．そのときに次のアナウンスを行ってください． 
	...
	* 発表件数と各発表の持ち時間，ベルが鳴る時間と回数を説明（1鈴：12分，2鈴：15分）
	* オンライン開催に関する依頼事項をアナウンス
		1. 「今年は質疑の仕方が大きく異なります。Webexでは研究発表のみを行い、質疑は受け付けません。研究発表が終わった後に全員でoVice会場へ移り、質疑はそこで残りのセッション時間一杯行われます。」
		2. 参加者は各自のマイクをミュートにすること（ノイズの混入を避けるため）
		3. 発表者以外はビデオをOFFにすること（通信帯域を節約するため．座長とコメンテータはON）
		4. 事務局が強制的にマイクミュートやビデオをOFFにする場合があること
		5. 外部公開の予定はないが，全ての発表は録画されていること
		6. トラブルなどは「チャット」で連絡すること
	* その他表彰などのアナウンス
...
6. 「退席」ボタンによりミーティングから退席して、ブラウザ上のoViceへ移る．
7. oVice上では、各発表者がブースに分かれて待っているので、順に回って、質問やコメントを伝えて回る。
8. セッション終了時刻になったら、学生アルバイトがoVice会場でセッション終了した旨のアナウンスを流す。 
	* 座長からのアナウンスは特にない。
	* oViceは休憩時間も使い続けられるので、他の参加者との挨拶・雑談や、発表者との追加の研究議論などにお使いください。
10. 座長は，学生プレゼンテーション賞の選考結果を提出する．
...
* 予稿原稿はありません．
* 発表時間は他の研究発表と同じで1件15分です．ただし、oViceでの質疑の時間がたっぷりとありますので、厳密に扱わないで20分程度までは許容してあげていただければと思います．
